  ...
  if (isMobile) {
    ...
    $('.select-sign-up').change(function(){
      ...
      if (pivot) {
        ...
        $('.row-show-skills').css('margin-top', '6px');
        $('.row-show-skills').addClass('select-skill-valid');
      } else {
        $('.label-skill-sign-up').removeClass('active');
        $('.row-show-skills').css('margin-top', '40px');
        $('.row-show-skills').removeClass('select-skill-valid');
      }
    });
    ...
    $('.select-edit-company').change(function(){
      ...
      if (pivot) {
        $('.label-skill-sign-up').addClass('active');
        $('.row-show-skill-edit').css('margin-top', '5px');
        $('.show-skills-edit-company').addClass('select-skill-valid');
      } else {
        $('.label-skill-sign-up').removeClass('active');
        $('.row-show-skill-edit').css('margin-top', '41px');
    ...
    $('.select-new-project').change(function(){
      ...
      if (pivot) {
        $('.label-skill-sign-up').addClass('active');
        $('.show-skills-new-project').css('margin-top', '6px');
        $('.show-skills-new-project').addClass('select-skill-valid');
      } else {
        $('.label-skill-sign-up').removeClass('active');
        $('.show-skills-new-project').css('margin-top', '42px');
        $('.show-skills-new-project').removeClass('select-skill-valid');
      }
    });
  }  
});
